...
The mean Corruption Average Precision (mCAP) is defined as: 
...
The relative mean Corruption Average Precision (rmCAP) is defined as:
\begin{equation}
\mathrm{rmCAP}
=
\frac{1}{|C|}
...
\midrule
\multicolumn{3}{l}{\textbf{YOLOV++}} \\
Single-frame baseline                 & \underline{11.3} & \underline{20.1} \\
Sampling local, 1 reference frame     & 11.4 & 21.7 \\
Sampling local, 3 reference frames    & 11.5 & 21.8 \\
Sampling local, 7 reference frames    & 11.4 & 21.8 \\
Sampling random, 1 reference frame    & 11.7 & 22.1 \\
Sampling random, 3 reference frames   & 11.9 & 22.6 \\
Sampling random, 7 reference frames   & \textbf{12.0} & \textbf{23.0} \\
\midrule
\multicolumn{3}{l}{\textbf{TransVOD++}} \\
Single-frame baseline                 & 18.3 & 33.3 \\
Sampling stride 1, 1 reference frame  & 18.7 & 34.0 \\
Sampling stride 1, 3 reference frames & 18.9 & 34.5 \\
Sampling stride 1, 7 reference frames & \textbf{19.1} & \textbf{34.7} \\
Sampling stride 1, 15 reference frames& 18.5 & 34.0 \\
Sampling stride 8, 1 reference frame  & 18.5 & 33.5 \\
Sampling stride 8, 3 reference frames & 18.5 & 33.7 \\
Sampling stride 8, 7 reference frames & 18.2 & 33.2 \\
Sampling stride 8, 15 reference frames& \underline{17.0} & \underline{31.2} \\
\bottomrule
\end{tabular}
\end{table}
